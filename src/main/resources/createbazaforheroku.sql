...
INSERT INTO book (title, description, author, isbn, printYear, readAlready) VALUE ('Head First Java, 2nd Edition', 'The fact is your brain craves novelty. Its constantly searching, scanning, waiting for something unusual to happen.', 'Kathy Sierra, Bert Bates', 0596009208, 2016, 1);
INSERT INTO book (title, description, author, isbn, printYear, readAlready) VALUE ('Java, A Beginner''s Guide, 5th Edition', 'Learn the fundamentals of Java programming in no time from bestselling programming author Herb Schildt.', 'Herbert Schildt', 0071606327, 2017, 1);
